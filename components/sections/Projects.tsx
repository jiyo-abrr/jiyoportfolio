        ...
        {[
          ...
          <div key={idx} className="group relative glass rounded-[2.5rem] overflow-hidden transition-all duration-500 hover:border-primary/30">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 p-8 md:p-12">
              ...
              <div className="lg:col-span-8 space-y-8">
                ...
                <div className="flex flex-wrap gap-2 pt-2">
                  {project.tags.map(tag => (
                    <span key={tag} className="px-3 py-1 bg-background border border-border/50 text-xs text-muted-foreground rounded-full font-medium shadow-sm">
                      {tag}
                    </span>
                  ))}
                </div>
              ...
              <div className="lg:col-span-4 flex lg:flex-col justify-end lg:justify-center items-start lg:items-end gap-6 pt-8 lg:pt-0 border-t lg:border-t-0 lg:border-l border-border/50 lg:pl-12">
