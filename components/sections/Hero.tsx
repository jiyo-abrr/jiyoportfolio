        ...
        <div className="flex flex-col gap-8 md:gap-10 relative z-10">
          ...
          >
            <div className="space-y-4 md:space-y-6">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/5 border border-primary/10 text-[10px] font-bold uppercase tracking-[0.3em] text-primary shadow-sm w-fit">
              ...
              <div className="space-y-3 md:space-y-4">
                <h1 className="text-5xl sm:text-7xl md:text-8xl font-medium tracking-tight text-foreground leading-[0.85]">
              ...
              <p className="text-sm md:text-xl text-muted-foreground font-light max-w-xl leading-relaxed pt-1 md:pt-4">
            ...
            <div className="flex flex-wrap items-center gap-4 sm:gap-6 pt-4 md:pt-6">
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                href="#contact"
                className="w-fit h-11 md:h-14 px-6 sm:px-10 flex items-center justify-center gap-2 md:gap-3 rounded-full bg-foreground text-background text-[14px] sm:text-base font-semibold hover:bg-primary transition-colors shadow-2xl shadow-primary/10"
              >
