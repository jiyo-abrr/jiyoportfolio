...
const Squares: React.FC<SquaresProps> = ({
  ...
  useEffect(() => {
    ...
    const drawGrid = () => {
      ...
      // Resolve CSS variables if they are passed as strings
      ...
      const resolvedHoverColor = resolveColor(hoverFillColor);
      ...
      for (let x = startX; x < canvas.width + squareSize; x += squareSize) {
        for (let y = startY; y < canvas.height + squareSize; y += squareSize) {
          ...
          ctx.lineWidth = 0.5; // Thin lines for less distraction
